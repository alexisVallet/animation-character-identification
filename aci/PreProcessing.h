 ...
 */
void preProcessing(const Mat_<Vec3b> &rawImage, const Mat_<float> &rawMask, Mat_<Vec3b> &processedImage, Mat_<float> &processedMask, int kuwaharaHalfsize = DEFAULT_KUWAHARA_HALFSIZE, int maxNbPixels = DEFAULT_MAX_NB_PIXELS);
